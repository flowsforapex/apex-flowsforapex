...
apex_string.join_clob(
  ...
  , '      <bpmn:messageEventDefinition id="MessageEventDefinition_0p023ka" />'
  , '    </bpmn:startEvent>'
  ...
  , '    <bpmn:sequenceFlow id="Flow_0leqi57" sourceRef="Gateway_1bnb7cm" targetRef="Activity_1vge0u1" />'
  ...
  , '      <bpmn:outgoing>Flow_0asf15k</bpmn:outgoing>'
  , '      <bpmn:outgoing>Flow_0c2vtqz</bpmn:outgoing>'
  , '      <bpmn:startEvent id="Event_1clgqjn">'
  ...
  , '        <bpmn:outgoing>Flow_0oqd9wl</bpmn:outgoing>'
  ...
  , '        <bpmn:outgoing>Flow_1pw80g0</bpmn:outgoing>'
  , '        <bpmn:escalationEventDefinition id="EscalationEventDefinition_1wk9jkt" />'
  , '      </bpmn:intermediateThrowEvent>'
  , '      <bpmn:task id="Activity_1hpefpd" name="Order from supplier">'
  , '        <bpmn:incoming>Flow_0oqd9wl</bpmn:incoming>'
  , '        <bpmn:incoming>Flow_1pw80g0</bpmn:incoming>'
  , '        <bpmn:outgoing>Flow_05iwzn7</bpmn:outgoing>'
  , '      </bpmn:task>'
  , '      <bpmn:sequenceFlow id="Flow_0oqd9wl" name="&#60; = 2 days" sourceRef="Gateway_0y4d9cr" targetRef="Activity_1hpefpd" />'
  , '      <bpmn:sequenceFlow id="Flow_05iwzn7" sourceRef="Activity_1hpefpd" targetRef="Event_137dw80" />'
  , '      <bpmn:intermediateCatchEvent id="Event_137dw80" name="article received">'
  , '        <bpmn:incoming>Flow_05iwzn7</bpmn:incoming>'
  ...
  , '      <bpmn:sequenceFlow id="Flow_1pw80g0" sourceRef="Event_1t737q3" targetRef="Activity_1hpefpd" />'
  ...
  , '    </bpmn:subProcess>'
  , '    <bpmn:sequenceFlow id="Flow_02pdkzm" sourceRef="Gateway_1bnb7cm" targetRef="Activity_0qoql0l" />'
  ...
  , '      <bpmn:incoming>Flow_0asf15k</bpmn:incoming>'
  , '      <bpmn:outgoing>Flow_0k56fv4</bpmn:outgoing>'
  , '    </bpmn:task>'
  , '    <bpmn:sequenceFlow id="Flow_0asf15k" name="Late delivery" sourceRef="Activity_1vge0u1" targetRef="Activity_13qn4iy" />'
  , '    <bpmn:task id="Activity_159n99f" name="Inform Customer">'
  , '      <bpmn:incoming>Flow_0c2vtqz</bpmn:incoming>'
  ...
  , '    <bpmn:sequenceFlow id="Flow_0c2vtqz" name="undeliverable" sourceRef="Activity_1vge0u1" targetRef="Activity_159n99f" />'
  ...
  , '      </bpmndi:BPMNEdge>'
  , '      <bpmndi:BPMNEdge id="Flow_0asf15k_di" bpmnElement="Flow_0asf15k">'
  , '        <di:waypoint x="1180" y="710" />'
  , '        <di:waypoint x="1180" y="860" />'
  , '        <di:waypoint x="1280" y="860" />'
  , '        <bpmndi:BPMNLabel>'
  , '          <dc:Bounds x="1188" y="782" width="63" height="14" />'
  , '        </bpmndi:BPMNLabel>'
  , '      </bpmndi:BPMNEdge>'
  ...
  , '      </bpmndi:BPMNEdge>'
  , '      <bpmndi:BPMNEdge id="Flow_0c2vtqz_di" bpmnElement="Flow_0c2vtqz">'
  , '        <di:waypoint x="980" y="710" />'
  , '        <di:waypoint x="980" y="1000" />'
  , '        <di:waypoint x="1060" y="1000" />'
  , '        <bpmndi:BPMNLabel>'
  , '          <dc:Bounds x="893" y="782" width="66" height="14" />'
  , '        </bpmndi:BPMNLabel>'
  , '      </bpmndi:BPMNEdge>'
  ...
  , '      </bpmndi:BPMNEdge>'
  , '      <bpmndi:BPMNShape id="Event_19ysx6e_di" bpmnElement="Event_0ob5sj9">'
  ...
  , '        <bpmndi:BPMNLabel>'
  , '          <dc:Bounds x="1946" y="245" width="89" height="14" />'
  , '        </bpmndi:BPMNLabel>'
  , '      </bpmndi:BPMNShape>'
  ...
  , '        <dc:Bounds x="500" y="360" width="940" height="350" />'
  , '      </bpmndi:BPMNShape>'
  ...
  , '        <bpmndi:BPMNLabel>'
  , '          <dc:Bounds x="978" y="542" width="33" height="14" />'
  , '        </bpmndi:BPMNLabel>'
  , '      </bpmndi:BPMNEdge>'
  , '      <bpmndi:BPMNEdge id="Flow_0oqd9wl_di" bpmnElement="Flow_0oqd9wl">'
  , '        <di:waypoint x="910" y="535" />'
  , '        <di:waypoint x="910" y="420" />'
  , '        <di:waypoint x="1020" y="420" />'
  , '        <bpmndi:BPMNLabel>'
  , '          <dc:Bounds x="844" y="475" width="52" height="14" />'
  , '        </bpmndi:BPMNLabel>'
  , '      </bpmndi:BPMNEdge>'
  ...
  , '        <bpmndi:BPMNLabel>'
  , '          <dc:Bounds x="919" y="625" width="13" height="14" />'
  , '        </bpmndi:BPMNLabel>'
  , '      </bpmndi:BPMNEdge>'
  , '      <bpmndi:BPMNEdge id="Flow_1pw80g0_di" bpmnElement="Flow_1pw80g0">'
  , '        <di:waypoint x="1070" y="542" />'
  , '        <di:waypoint x="1070" y="460" />'
  , '      </bpmndi:BPMNEdge>'
  , '      <bpmndi:BPMNEdge id="Flow_05iwzn7_di" bpmnElement="Flow_05iwzn7">'
  ...
  , '        <bpmndi:BPMNLabel>'
  , '          <dc:Bounds x="1332" y="475" width="77" height="14" />'
  , '        </bpmndi:BPMNLabel>'
  , '      </bpmndi:BPMNShape>'
  ...
  , '        </bpmndi:BPMNLabel>'
  , '      </bpmndi:BPMNShape>'
  , '      <bpmndi:BPMNShape id="Activity_1hpefpd_di" bpmnElement="Activity_1hpefpd">'
  ...
  , '        <bpmndi:BPMNLabel>'
  , '          <dc:Bounds x="947" y="695" width="66" height="14" />'
  , '        </bpmndi:BPMNLabel>'
  , '      </bpmndi:BPMNShape>'
  , '      <bpmndi:BPMNShape id="Event_01ibwps_di" bpmnElement="Event_1t737q3">'
  , '        <dc:Bounds x="1052" y="542" width="36" height="36" />'
  , '        <bpmndi:BPMNLabel>'
  , '          <dc:Bounds x="1038" y="588" width="63" height="14" />'
  , '        </bpmndi:BPMNLabel>'
  , '      </bpmndi:BPMNShape>'
  , '      <bpmndi:BPMNShape id="Activity_0hcqzcx_di" bpmnElement="Activity_0hjhoia">'
