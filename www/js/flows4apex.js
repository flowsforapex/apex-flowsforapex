...
function initPage2(){
  ...
  apex.jQuery(window).on('theme42ready', function() {
    ...
    $(".a-IRR-headerLabel, .a-IRR-headerLink").each(function() {
      var text = $(this).text();
      if (text == 'Created') {
        $(this).parent().addClass("prcs_status--created");
      }
      else if (text == 'Completed') {
        $(this).parent().addClass("prcs_status--completed");
      }
      else if (text == 'Running') {
        $(this).parent().addClass("prcs_status--running");
      }
      else if (text == 'Terminated') {
        $(this).parent().addClass("prcs_status--terminated");
      }
      else if (text == 'Error') {
        $(this).parent().addClass("prcs_status--error");
      }
    });
...
function initPage3(){
  initApp();
  apex.jQuery(window).on('theme42ready', function() {
    apex.jQuery('span[data-status="created"]').parents("span.t-BadgeList-wrap").addClass("prcs_status--created");
    apex.jQuery('span[data-status="running"]').parents("span.t-BadgeList-wrap").addClass("prcs_status--running");
    apex.jQuery('span[data-status="completed"]').parents("span.t-BadgeList-wrap").addClass("prcs_status--completed");
    apex.jQuery('span[data-status="terminated"]').parents("span.t-BadgeList-wrap").addClass("prcs_status--terminated");
    apex.jQuery('span[data-status="error"]').parents("span.t-BadgeList-wrap").addClass("prcs_status--error");
  });
}

function initPage7(){
  apex.jQuery(window).on('theme42ready', function() {
    apex.jQuery('span[data-status="created"]').parents("span.t-BadgeList-value").addClass(["prcs_status--created", "instance-counter-link"]);
    apex.jQuery('span[data-status="running"]').parents("span.t-BadgeList-value").addClass(["prcs_status--running", "instance-counter-link"]);
    apex.jQuery('span[data-status="completed"]').parents("span.t-BadgeList-value").addClass(["prcs_status--completed", "instance-counter-link"]);
    apex.jQuery('span[data-status="terminated"]').parents("span.t-BadgeList-value").addClass(["prcs_status--terminated", "instance-counter-link"]);
    apex.jQuery('span[data-status="error"]').parents("span.t-BadgeList-value").addClass(["prcs_status--error", "instance-counter-link"]);
  });
}
    ...
    if ( action !== "view-flow-instance" || ( action === "view-flow-instance" && displaySetting === "window") ) {
      ...
      result.done( function( data ) {
        if (!data.success) {
          ...
          else if ( action === "view-flow-instance" || action === "flow-instance-audit" || action === "edit-flow-diagram" ) {
            apex.navigation.redirect(data.url);
          } else {
