...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[      <bpmn:timerEventDefinition id="TimerEventDefinition_1yvpnqn" apex:timerType="oracleDuration">]'
      ,q'[        <bpmn:extensionElements>]'
      ,q'[          <apex:oracleDuration>]'
      ,q'[            <apex:intervalYM>00-00</apex:intervalYM>]'
      ,q'[            <apex:intervalDS>000 00:00:20</apex:intervalDS>]'
      ,q'[          </apex:oracleDuration>]'
      ,q'[        </bpmn:extensionElements>]'
      ,q'[      </bpmn:timerEventDefinition>]'
      ...
      ,q'[]'
      ,q'[The specific date timers are easiest used if you substitute a Date process variable into the Timer Definition string.]'
      ,q'[]'
      ,q'[And starting in v22.1, you can use Oracle date format strings if you prefer over ISO8601.</bpmn:text>]'
      ,q'[    </bpmn:textAnnotation>]'
      ...
      ,q'[]'
      ,q'[The scheduler is not set up for you when you install Flows for APEX.  It's simple to do this, however - once you have a user with CREATE JOB, you have to execute 2 pl/sql procedures that are included in the F4A distribution - see this file in the distribution.  setup/DBMS_SCHEDULER_setup_for_timers.txt]'
      ,q'[]'
      ,q'[And starting with v22.1, a non-interrupting timer boundary event like this can be configured to fire repetitively.  You can set this reminder to go off, for example,  everyday, or every 3* weeks, upto a maximum of 15* times.   (all numbers configurable).]'
      ,q'[]'
      ...
      ,q'[    <bpmn:textAnnotation id="TextAnnotation_0qc0nl1">]'
      ,q'[      <bpmn:text>This Timer is also a 20 second delay, but if you open the Properties Panel on the right, you can see that it is defined using an Oracle format Duration. (new in v22.1).]'
      ,q'[]'
      ,q'[The Duration is split into two components:]'
      ,q'[- a Year-Month component, using the format YY-MM.  e.g., 01-06 for 1 Year and 6 Months]'
      ,q'[- a Days-Hours-Minutes-Seconds component, using the format DDD HH:MI:SS.]'
      ,q'[  for example,  '010 12:30:15' would delay the process for 10 days, 12 Hours, 30 Minutes and 15 seconds.]'
      ,q'[]'
      ,q'[If you specify both a Years-Month and a Days-Hours-Minutes-Seconds component they are combined to get the delay.</bpmn:text>]'
      ,q'[    </bpmn:textAnnotation>]'
      ,q'[    <bpmn:association id="Association_12fh2so" sourceRef="Event_0r62ngx" targetRef="TextAnnotation_0qc0nl1" />]'
      ,q'[  </bpmn:process>]'
      ,q'[  <bpmndi:BPMNDiagram id="BPMNDiagram_1">]'
      ,q'[    <bpmndi:BPMNPlane id="BPMNPlane_1" bpmnElement="Process_AA7_Timers">]'
      ,q'[      <bpmndi:BPMNShape id="TextAnnotation_0qc0nl1_di" bpmnElement="TextAnnotation_0qc0nl1">]'
      ,q'[        <dc:Bounds x="860" y="560" width="578.125" height="184.375" />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="TextAnnotation_1lvcb8y_di" bpmnElement="TextAnnotation_1lvcb8y">]'
      ,q'[        <dc:Bounds x="1010" y="350" width="350" height="170" />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ...
      ,q'[        <dc:Bounds x="220" y="530" width="550" height="230" />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNEdge id="Association_12fh2so_di" bpmnElement="Association_12fh2so">]'
      ,q'[        <di:waypoint x="680" y="325" />]'
      ,q'[        <di:waypoint x="860" y="585" />]'
      ,q'[      </bpmndi:BPMNEdge>]'
      ,q'[      <bpmndi:BPMNEdge id="Association_0dpxqu1_di" bpmnElement="Association_0dpxqu1">]'
      ,q'[        <di:waypoint x="870" y="335" />]'
      ,q'[        <di:waypoint x="1010" y="401" />]'
      ,q'[      </bpmndi:BPMNEdge>]'
