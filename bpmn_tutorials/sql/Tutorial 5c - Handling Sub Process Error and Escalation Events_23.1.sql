...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[  <bpmn:process id="Tutorial5c" name="Tutorial 5c - SubProcess Errors and Escalations" isExecutable="false" apex:isCallable="false" apex:manualInput="false">]'
      ...
      ,q'[]'
      ,q'[Error Events and Escalation Events can be used to send Errors and Escalations from inside a SubProcess or CallActivity to their Calling Process Level.  They are only used with SubProcesses and CallActivities.</bpmn:text>]'
      ,q'[    </bpmn:textAnnotation>]'
      ...
      ,q'[        <dc:Bounds x="550" y="-120" width="930" height="279" />]'
      ,q'[        <bpmndi:BPMNLabel />]'
      ,q'[      </bpmndi:BPMNShape>]'
