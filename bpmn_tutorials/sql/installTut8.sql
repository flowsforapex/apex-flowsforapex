...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[]'
      ,q'[From v21.1, you can control whether you want the process to have a normal 'completed' status, or a 'terminated' status to highlight an abnormal end.  Set in the properties panel. --&gt;]'
      ,q'[]'
