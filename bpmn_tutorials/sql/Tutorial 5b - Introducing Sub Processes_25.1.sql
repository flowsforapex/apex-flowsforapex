...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[  <bpmn:process id="Tutorial_05b" name="Tutorial - Introducing Sub Processes" isExecutable="true" apex:isCallable="false" apex:isStartable="true" apex:manualInput="false">]'
      ...
      ,q'[    </bpmn:startEvent>]'
      ,q'[    <bpmn:task id="Activity_13yt1ft" name="Tutorial 5b&#10;SubProcesses">]'
      ...
      ,q'[      <bpmn:text>Tutorial 5b - Sub Processes]'
      ,q'[]'
      ,q'[A Sub Process is defined inside the diagram that it is used on.]'
      ,q'[]'
      ,q'[Sub Processes can encapsulate part of your business process, hiding the details when necessary.  This diagram shows an expanded subprocess - where you can see the inside steps on the same page as the parent - but you could also draw this using collapsed sub processes, where the inside details of the parent subprocess are not visible on the parent page.]'
      ,q'[]'
      ...
      ,q'[    <bpmndi:BPMNPlane id="BPMNPlane_1" bpmnElement="Tutorial_05b">]'
      ,q'[      <bpmndi:BPMNShape id="Event_0iygv59_di" bpmnElement="Event_0iygv59">]'
      ,q'[        <dc:Bounds x="242" y="292" width="36" height="36" />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Activity_13yt1ft_di" bpmnElement="Activity_13yt1ft" bioc:stroke="#6b3c00" bioc:fill="#ffe0b2" color:background-color="#ffe0b2" color:border-color="#6b3c00">]'
      ...
      ,q'[        </bpmndi:BPMNLabel>]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Activity_19cs6tz_di" bpmnElement="Activity_1l75ys0" isExpanded="true" bioc:stroke="#831311" bioc:fill="#ffcdd2" color:background-color="#ffcdd2" color:border-color="#831311">]'
      ...
      ,q'[        <di:waypoint x="992" y="210" />]'
      ,q'[        <di:waypoint x="976" y="180" />]'
      ,q'[      </bpmndi:BPMNEdge>]'
      ...
      ,q'[        <dc:Bounds x="820" y="0" width="629.9874206625337" height="179.98592155343286" />]'
      ,q'[        <bpmndi:BPMNLabel />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[    </bpmndi:BPMNPlane>]'
  ...
  flow_diagram.upload_and_parse(
    ...
    pi_dgrm_short_description => 'Flows for APEX BPMN Tutorial - Part 5b - shows you the details of how sub processes work.',
    pi_dgrm_description => '**Introducing Sub Processes**
