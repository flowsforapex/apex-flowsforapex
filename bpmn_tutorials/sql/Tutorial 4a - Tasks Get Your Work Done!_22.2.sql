...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[    <bpmn:sequenceFlow id="Flow_0mxa79i" sourceRef="Activity_1ysn2gx" targetRef="Event_1da6vg3" />]'
      ...
      ,q'[]'
      ,q'[In 22.1, you can use these to:]'
      ,q'[]'
      ...
      ,q'[        <dc:Bounds x="1382" y="362" width="36" height="36" />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ...
      ,q'[        <dc:Bounds x="560" y="178" width="429.9999694824219" height="123.98896026611328" />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ...
      ,q'[        <dc:Bounds x="1270" y="172" width="220" height="127" />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ...
      ,q'[        <di:waypoint x="1241" y="340" />]'
      ,q'[        <di:waypoint x="1270" y="284" />]'
      ,q'[      </bpmndi:BPMNEdge>]'
