...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[    <bpmn:userTask id="Activity_0srf4in" name="UserTask - I can call an APEX Page or APEX Approval" apex:type="apexPage" apex:manualInput="false">]'
      ...
      ,q'[    <bpmn:sequenceFlow id="Flow_104w405" sourceRef="Activity_1wg9nda" targetRef="Event_1da6vg3" />]'
      ,q'[    <bpmn:sendTask id="Activity_0l6ac3x" name="SendTask&#10;- sends a message to another process" apex:type="basicApexMessage">]'
      ,q'[      <bpmn:incoming>Flow_0mxa79i</bpmn:incoming>]'
      ,q'[      <bpmn:outgoing>Flow_1pjx0pk</bpmn:outgoing>]'
      ,q'[    </bpmn:sendTask>]'
      ,q'[    <bpmn:receiveTask id="Activity_1wg9nda" name="ReceiveTask&#10;- receives a message from another process" apex:type="basicApexMessage">]'
      ...
      ,q'[]'
      ,q'[A UserTask can also call an APEX Approval Task in APEX v22.1+.</bpmn:text>]'
      ,q'[    </bpmn:textAnnotation>]'
      ...
      ,q'[        <dc:Bounds x="270" y="30" width="620" height="124" />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ...
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Activity_0lrcet4_di" bpmnElement="Activity_1ysn2gx">]'
      ...
      ,q'[        <dc:Bounds x="560" y="178" width="430" height="142" />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ...
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Activity_15lsg1n_di" bpmnElement="Activity_0l6ac3x">]'
      ,q'[        <dc:Bounds x="1330" y="340" width="100" height="80" />]'
      ,q'[        <bpmndi:BPMNLabel />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Activity_0tfwzsa_di" bpmnElement="Activity_1wg9nda">]'
      ,q'[        <dc:Bounds x="1510" y="340" width="100" height="80" />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNEdge id="Association_00jab7b_di" bpmnElement="Association_00jab7b">]'
      ,q'[        <di:waypoint x="273" y="363" />]'
      ,q'[        <di:waypoint x="220" y="230" />]'
      ,q'[        <di:waypoint x="220" y="92" />]'
      ,q'[        <di:waypoint x="261" y="92" />]'
      ,q'[      </bpmndi:BPMNEdge>]'
      ...
      ,q'[        <di:waypoint x="685" y="420" />]'
      ,q'[        <di:waypoint x="665" y="440" />]'
      ,q'[      </bpmndi:BPMNEdge>]'
