...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[  <bpmn:process id="Tutorial_05b" name="Tutorial - Introducing Sub Processes" isExecutable="false" apex:isCallable="false" apex:manualInput="false">]'
