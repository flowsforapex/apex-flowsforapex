...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[    <bpmn:sendTask id="Activity_0mhkzh2" name="SendTask" apex:type="basicApexMessage">]'
      ...
      ,q'[    <bpmn:intermediateThrowEvent id="Event_0m1a6k2" name="Message Throw Event" apex:type="basicApexMessage">]'
      ...
      ,q'[    <bpmn:receiveTask id="Activity_0zzol2u" name="ReceiveTask" apex:type="basicApexMessage">]'
      ,q'[      <bpmn:incoming>Flow_111ldh8</bpmn:incoming>]'
      ,q'[      <bpmn:outgoing>Flow_149xi7o</bpmn:outgoing>]'
      ,q'[    </bpmn:receiveTask>]'
      ,q'[    <bpmn:intermediateCatchEvent id="Event_02gdru8" name="Message Catch Event" apex:type="basicApexMessage">]'
