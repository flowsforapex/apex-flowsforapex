...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[  <bpmn:process id="Tutorial5c" name="Tutorial 5c - SubProcess Errors and Escalations" isExecutable="true" apex:isCallable="false" apex:isStartable="true" apex:manualInput="false">]'
      ...
      ,q'[    </bpmn:startEvent>]'
      ,q'[    <bpmn:task id="Activity_13yt1ft" name="Tutorial 5c&#10;SubProcess Errors and Escalations">]'
      ...
      ,q'[        <bpmn:sequenceFlow id="Flow_1x95h95" name="N" sourceRef="Gateway_0qtnlf2" targetRef="Activity_1nqf2t2" apex:sequence="20" />]'
      ...
      ,q'[        </bpmn:task>]'
      ,q'[        <bpmn:sequenceFlow id="Flow_18i162p" name="Y" sourceRef="Gateway_0qtnlf2" targetRef="Activity_1ummob2" apex:sequence="30" />]'
      ...
      ,q'[      </bpmn:exclusiveGateway>]'
      ,q'[      <bpmn:sequenceFlow id="Flow_00jpo2b" name="Yes" sourceRef="Gateway_0okheq5" targetRef="Activity_0ksy34k" apex:sequence="20" />]'
      ...
      ,q'[      <bpmn:sequenceFlow id="Flow_1n7yz35" sourceRef="Gateway_0okheq5" targetRef="Event_1yflz91" apex:sequence="30" />]'
      ...
      ,q'[      </bpmn:task>]'
      ,q'[      <bpmn:sequenceFlow id="Flow_0rzsiz6" sourceRef="Event_0ilybau" targetRef="Activity_0czq539" apex:sequence="10" />]'
      ...
      ,q'[    <bpmn:serviceTask id="Activity_1b9ghnl" name="Email Manager for Help" apex:type="executePlsql">]'
      ...
      ,q'[]'
      ,q'[Note that we're talking about business process Escalations (and Errors) here - not technical escalations (or errors!).]'
      ,q'[]'
      ,q'[Error Events and Escalation Events can be used to send Errors and Escalations from inside a SubProcess or CallActivity to their Calling Process Level.  They are only used with SubProcesses and CallActivities.]'
      ,q'[]'
      ,q'[So here the Error End Event (Pink) throws an Error to the Error Boundary Event (Pink) resulting in SubProcess B4 taking a different End path if an error is signalled.]'
      ,q'[]'
      ,q'[And the Escalation Throw Event (Purple) in SubProcess B throws an escalation which is caught by the non-interrupting escalation catch event on the outside of SubProcess B, (Purple) - causing the ]'
      ,q'[purple path to execute</bpmn:text>]'
      ,q'[    </bpmn:textAnnotation>]'
      ...
      ,q'[    <bpmndi:BPMNPlane id="BPMNPlane_1" bpmnElement="Tutorial5c">]'
      ...
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Activity_0x9pws1_di" bpmnElement="Activity_1lt3f7j" isExpanded="true" bioc:stroke="#6b3c00" bioc:fill="#ffe0b2" color:background-color="#ffe0b2" color:border-color="#6b3c00">]'
      ...
      ,q'[        </bpmndi:BPMNLabel>]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Activity_19cs6tz_di" bpmnElement="Activity_1l75ys0" isExpanded="true" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:background-color="#c8e6c9" color:border-color="#205022">]'
      ...
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Event_0ppaw77_di" bpmnElement="Event_185dh52" bioc:stroke="#831311" bioc:fill="#ffcdd2" color:background-color="#ffcdd2" color:border-color="#831311">]'
      ...
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Event_0inroqp_di" bpmnElement="Event_1yflz91" bioc:stroke="#5b176d" bioc:fill="#e1bee7" color:background-color="#e1bee7" color:border-color="#5b176d">]'
      ,q'[        <dc:Bounds x="1282" y="422" width="36" height="36" />]'
      ,q'[        <bpmndi:BPMNLabel>]'
      ,q'[          <dc:Bounds x="1258" y="465" width="85" height="27" />]'
      ,q'[        </bpmndi:BPMNLabel>]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Activity_0czq539_di" bpmnElement="Activity_0czq539" bioc:stroke="#831311" bioc:fill="#ffcdd2" color:background-color="#ffcdd2" color:border-color="#831311">]'
      ,q'[        <dc:Bounds x="1480" y="670" width="100" height="80" />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Event_0jj0hcj_di" bpmnElement="Event_0jj0hcj" bioc:stroke="#831311" bioc:fill="#ffcdd2" color:background-color="#ffcdd2" color:border-color="#831311">]'
      ...
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Event_0nr80d2_di" bpmnElement="Event_0ilybau" bioc:stroke="#831311" bioc:fill="#ffcdd2" color:background-color="#ffcdd2" color:border-color="#831311">]'
      ...
      ,q'[        </bpmndi:BPMNLabel>]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Activity_13xmf2s_di" bpmnElement="Activity_1b9ghnl" bioc:stroke="#5b176d" bioc:fill="#e1bee7" color:background-color="#e1bee7" color:border-color="#5b176d">]'
      ,q'[        <dc:Bounds x="1460" y="850" width="100" height="80" />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Event_099tlz0_di" bpmnElement="Event_099tlz0" bioc:stroke="#5b176d" bioc:fill="#e1bee7" color:background-color="#e1bee7" color:border-color="#5b176d">]'
      ,q'[        <dc:Bounds x="1612" y="872" width="36" height="36" />]'
      ,q'[        <bpmndi:BPMNLabel>]'
      ,q'[          <dc:Bounds x="1599" y="915" width="62" height="27" />]'
      ,q'[        </bpmndi:BPMNLabel>]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Activity_1mbzten_di" bpmnElement="Activity_1mbzten" bioc:stroke="#5b176d" bioc:fill="#e1bee7" color:background-color="#e1bee7" color:border-color="#5b176d">]'
      ,q'[        <dc:Bounds x="1330" y="850" width="100" height="80" />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNEdge id="Association_0ccwauj_di" bpmnElement="Association_0ccwauj">]'
      ,q'[        <di:waypoint x="873" y="210" />]'
      ,q'[        <di:waypoint x="825" y="159" />]'
      ,q'[      </bpmndi:BPMNEdge>]'
      ,q'[      <bpmndi:BPMNShape id="Event_170xafm_di" bpmnElement="Event_05m9taf" bioc:stroke="#5b176d" bioc:fill="#e1bee7" color:background-color="#e1bee7" color:border-color="#5b176d">]'
      ...
      ,q'[        <dc:Bounds x="510" y="-160" width="1080" height="318.659423828125" />]'
      ,q'[        <bpmndi:BPMNLabel />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[    </bpmndi:BPMNPlane>]'
  ...
  flow_diagram.upload_and_parse(
    ...
    pi_dgrm_short_description => 'Flows for APEX BPMN Tutorial - part 5c - shows how you can use error and escalation events inside a sub process to trigger actions in the parent process',
    pi_dgrm_description => '**SubProcess Errors and Escalations**
