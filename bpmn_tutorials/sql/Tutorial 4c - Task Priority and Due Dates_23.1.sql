...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[  <bpmn:process id="Process_Tutorial4c" name="Tutorial 4c" isExecutable="false" apex:manualInput="false">]'
      ...
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Activity_04hvvpj_di" bpmnElement="Activity_04hvvpj">]'
      ,q'[        <dc:Bounds x="400" y="390" width="100" height="80" />]'
      ,q'[        <bpmndi:BPMNLabel />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Activity_03fe5g1_di" bpmnElement="Activity_03fe5g1">]'
      ,q'[        <dc:Bounds x="560" y="390" width="100" height="80" />]'
      ,q'[        <bpmndi:BPMNLabel />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Activity_0k5mueu_di" bpmnElement="Activity_0k5mueu">]'
      ,q'[        <dc:Bounds x="720" y="390" width="100" height="80" />]'
      ,q'[        <bpmndi:BPMNLabel />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Activity_1sx6tny_di" bpmnElement="Activity_1sx6tny">]'
      ,q'[        <dc:Bounds x="1110" y="390" width="100" height="80" />]'
      ,q'[        <bpmndi:BPMNLabel />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Activity_0d46kjr_di" bpmnElement="Activity_0133nx5">]'
      ,q'[        <dc:Bounds x="1260" y="390" width="100" height="80" />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Event_1yl8fo0_di" bpmnElement="Event_1yl8fo0">]'
