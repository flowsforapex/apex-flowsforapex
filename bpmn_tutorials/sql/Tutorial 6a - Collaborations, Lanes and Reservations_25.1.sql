...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[  <bpmn:process id="Process_0rxermh" isExecutable="true" apex:isStartable="true" apex:minLoggingLevel="0">]'
      ...
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Lane_03etxno_di" bpmnElement="Lane_03etxno" isHorizontal="true" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:background-color="#c8e6c9" color:border-color="#205022">]'
      ,q'[        <dc:Bounds x="250" y="690" width="1780" height="304" />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Lane_06y2vip_di" bpmnElement="Lane_06y2vip" isHorizontal="true" bioc:stroke="#831311" bioc:fill="#ffcdd2" color:background-color="#ffcdd2" color:border-color="#831311">]'
      ,q'[        <dc:Bounds x="250" y="420" width="1780" height="270" />]'
      ,q'[        <bpmndi:BPMNLabel />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Lane_1di2z70_di" bpmnElement="Lane_1di2z70" isHorizontal="true" bioc:stroke="#6b3c00" bioc:fill="#ffe0b2" color:background-color="#ffe0b2" color:border-color="#6b3c00">]'
  ...
  flow_diagram.upload_and_parse(
    ...
    pi_dgrm_short_description => 'Flows for APEX BPMN Tutorial - Part 6a - expands our BPMN diagrams to include lanes, showing who will perform activities, and how tasks are assigned.',
    pi_dgrm_description => 'This BPMN tutorial is part of the Flows for APEX series, specifically designed to introduce and highlight the concept of lanes in process modeling. The tutorial emphasizes the importance of lanes, task assignment, and task reservation, which have not been included in the previous tutorials.
