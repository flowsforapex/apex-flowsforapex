...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Activity_1w86o6c_di" bpmnElement="Activity_1w86o6c">]'
      ...
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Activity_1kv9zax_di" bpmnElement="Activity_1kv9zax">]'
      ,q'[        <dc:Bounds x="600" y="400" width="100" height="80" />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Activity_0irzelz_di" bpmnElement="Activity_0irzelz">]'
      ,q'[        <dc:Bounds x="815" y="400" width="100" height="80" />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Activity_0vygmu9_di" bpmnElement="Activity_0vygmu9">]'
