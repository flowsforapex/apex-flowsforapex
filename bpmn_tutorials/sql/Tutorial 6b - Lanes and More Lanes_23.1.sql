...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[  <bpmn:process id="Process_cr2unkh0" isExecutable="false">]'
      ...
      ,q'[        <bpmndi:BPMNLabel />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Lane_11jtvuj_di" bpmnElement="Lane_11jtvuj" isHorizontal="true">]'
      ...
      ,q'[        <bpmndi:BPMNLabel />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Lane_0g7r886_di" bpmnElement="Lane_0g7r886" isHorizontal="true">]'
      ,q'[        <dc:Bounds x="420" y="450" width="1390" height="120" />]'
      ,q'[        <bpmndi:BPMNLabel />]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Lane_16vkzwu_di" bpmnElement="Lane_16vkzwu" isHorizontal="true">]'
      ...
      ,q'[      </bpmndi:BPMNEdge>]'
      ,q'[      <bpmndi:BPMNShape id="Group_1vb8gzv_di" bpmnElement="Group_1vb8gzv">]'
