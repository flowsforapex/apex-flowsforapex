...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[  <bpmn:process id="Process_0rxermh" isExecutable="false" apex:isCallable="false" apex:manualInput="false">]'
      ...
      ,q'[            <apex:varName>Bad_OnEvent</apex:varName>]'
      ,q'[            <apex:varDataType>NUMBER</apex:varDataType>]'
      ,q'[            <apex:varExpressionType>static</apex:varExpressionType>]'
      ,q'[            <apex:varExpression>&amp;F4A$Copy_to_On.</apex:varExpression>]'
      ,q'[          </apex:processVariable>]'
      ,q'[        </apex:onEvent>]'
      ,q'[        <apex:beforeEvent>]'
      ,q'[          <apex:processVariable>]'
      ,q'[            <apex:varSequence>0</apex:varSequence>]'
      ,q'[            <apex:varName>Bad_BeforeEvent</apex:varName>]'
      ,q'[            <apex:varDataType>NUMBER</apex:varDataType>]'
      ,q'[            <apex:varExpressionType>static</apex:varExpressionType>]'
      ,q'[            <apex:varExpression>&amp;F4A$Copy_to_Before.</apex:varExpression>]'
      ,q'[          </apex:processVariable>]'
      ,q'[        </apex:beforeEvent>]'
      ,q'[      </bpmn:extensionElements>]'
      ,q'[      <bpmn:outgoing>Flow_0kcnir7</bpmn:outgoing>]'
      ,q'[      <bpmn:timerEventDefinition id="TimerEventDefinition_0v38i8d">]'
      ...
      ,q'[        </bpmndi:BPMNLabel>]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Event_0pqfoag_di" bpmnElement="Event_StartA">]'
  ...
  flow_diagram.upload_and_parse(
    pi_dgrm_name => 'A03h - Model with one start event with bad before-event var exp',
    pi_dgrm_version => '0',
