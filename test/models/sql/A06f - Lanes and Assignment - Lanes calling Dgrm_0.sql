...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[  <bpmn:process id="Process_TwoLanes" name="TwoLanes" isExecutable="false" apex:isCallable="true">]'
      ...
      ,q'[      </bpmn:lane>]'
      ,q'[      <bpmn:lane id="Lane_Y" name="LaneY" apex:isRole="false">]'
      ...
      ,q'[        </bpmn:startEvent>]'
      ,q'[        <bpmn:sequenceFlow id="Flow_1kyqvsw" sourceRef="Event_B2Start" targetRef="Activity_Call06c" />]'
      ,q'[        <bpmn:sequenceFlow id="Flow_0ye62pn" sourceRef="Activity_Call06c" targetRef="Event_B2End" />]'
      ,q'[        <bpmn:endEvent id="Event_B2End" name="B2End">]'
      ,q'[          <bpmn:incoming>Flow_0ye62pn</bpmn:incoming>]'
      ,q'[        </bpmn:endEvent>]'
      ,q'[        <bpmn:callActivity id="Activity_Call06c" name="Call 06c" apex:manualInput="false" apex:calledDiagram="A06c - Lanes and Assignment - Lanes with SubProcs" apex:calledDiagramVersionSelection="latestVersion">]'
      ...
      ,q'[    </bpmn:userTask>]'
      ,q'[    <bpmn:userTask id="Activity_Y" name="Y" apex:type="apexPage" apex:manualInput="true">]'
      ,q'[      <bpmn:extensionElements>]'
      ,q'[        <apex:apexPage>]'
      ,q'[          <apex:applicationId>100</apex:applicationId>]'
      ,q'[          <apex:pageId>3</apex:pageId>]'
      ...
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Activity_052ymnb_di" bpmnElement="Activity_Y">]'
      ...
      ,q'[        </bpmndi:BPMNLabel>]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Activity_073pnto_di" bpmnElement="Activity_Call06c">]'
      ...
      ,q'[        </bpmndi:BPMNLabel>]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Activity_0mwyp1e_di" bpmnElement="Activity_B1">]'
      ...
      ,q'[        </bpmndi:BPMNLabel>]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Activity_1xeyel7_di" bpmnElement="Activity_A">]'
  ...
  flow_diagram.upload_and_parse(
    pi_dgrm_name => 'A06f - Lanes and Assignment - Lanes calling Dgrm',
    pi_dgrm_version => '0',
