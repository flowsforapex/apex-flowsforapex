...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[  <bpmn:process id="Process_TerminateEnd" name="Terminate End" isExecutable="false" apex:isCallable="true" apex:manualInput="false">]'
      ,q'[    <bpmn:documentation>This Process just implements a Called Activity with a Terminate  End.  It also sets a proc Var which can be returned on a normal ending</bpmn:documentation>]'
      ...
      ,q'[      <bpmn:terminateEventDefinition id="TerminateEventDefinition_1o5ud4e">]'
      ,q'[        <apex:processStatus>completed</apex:processStatus>]'
      ,q'[      </bpmn:terminateEventDefinition>]'
      ,q'[    </bpmn:endEvent>]'
      ,q'[  </bpmn:process>]'
      ,q'[  <bpmndi:BPMNDiagram id="BPMNDiagram_1">]'
      ,q'[    <bpmndi:BPMNPlane id="BPMNPlane_1" bpmnElement="Process_TerminateEnd">]'
      ...
      ,q'[        </bpmndi:BPMNLabel>]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Event_1b2p6nt_di" bpmnElement="Event_End_Called">]'
  ...
  flow_diagram.upload_and_parse(
    pi_dgrm_name => 'A14d - Called Activity with Terminate End',
    pi_dgrm_version => '0',
