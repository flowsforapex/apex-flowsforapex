...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[  <bpmn:process id="Process_A19e" name="A19e - Priority and Due Dates - SQL" isExecutable="true" apex:manualInput="false">]'
      ...
      ,q'[      <apex:dueOn>]'
      ,q'[        <apex:expressionType>sqlQuerySingle</apex:expressionType>]'
      ,q'[        <apex:expression>select to_timestamp_tz('2023-06-21 23:59:59 AMERICA/LOS_ANGELES','YYYY-MM-DD HH24:MI:SS TZR')]'
      ...
      ,q'[    <bpmndi:BPMNPlane id="BPMNPlane_1" bpmnElement="Process_A19e">]'
  ...
  flow_diagram.upload_and_parse(
    pi_dgrm_name => 'A19e - Priority and Due Dates - SQL',
    pi_dgrm_version => '0',
