...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[    <bpmn:intermediateCatchEvent id="Event_ICEMessage1" name="ICEMessage1" apex:type="basicApexMessage">]'
      ...
      ,q'[    <bpmn:intermediateCatchEvent id="Event_ICEMessage2" name="ICEMessage2" apex:type="basicApexMessage">]'
