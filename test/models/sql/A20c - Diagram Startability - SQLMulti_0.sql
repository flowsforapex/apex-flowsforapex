...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[  <bpmn:process id="Process_A20c" name="A20c - Startability - MultiSQL" isExecutable="true" apex:isStartable="true" apex:manualInput="false">]'
      ,q'[    <bpmn:extensionElements>]'
      ,q'[      <apex:potentialStartingUsers>]'
      ,q'[        <apex:expressionType>sqlQueryList</apex:expressionType>]'
      ,q'[        <apex:expression>select 'SMITH' from dual]'
      ,q'[union]'
      ,q'[select 'JONES' from dual]'
      ,q'[union ]'
      ,q'[select 'WONG' from dual</apex:expression>]'
      ,q'[      </apex:potentialStartingUsers>]'
      ,q'[      <apex:potentialStartingGroups>]'
      ,q'[        <apex:expressionType>sqlQueryList</apex:expressionType>]'
      ,q'[        <apex:expression>select 'SALES' from dual]'
      ,q'[union]'
      ,q'[select 'MARKETING' from dual]'
      ,q'[union]'
      ,q'[select 'SQLMULTI' from dual</apex:expression>]'
      ,q'[      </apex:potentialStartingGroups>]'
      ,q'[      <apex:excludedStartingUsers>]'
      ,q'[        <apex:expressionType>sqlQueryList</apex:expressionType>]'
      ,q'[        <apex:expression>select 'BADBOSS' from dual ]'
      ,q'[union]'
      ,q'[select 'MULTIBOSS' from dual</apex:expression>]'
      ,q'[      </apex:excludedStartingUsers>]'
      ,q'[    </bpmn:extensionElements>]'
      ...
      ,q'[    <bpmndi:BPMNPlane id="BPMNPlane_1" bpmnElement="Process_A20c">]'
  ...
  flow_diagram.upload_and_parse(
    pi_dgrm_name => 'A20c - Diagram Startability - SQLMulti',
    pi_dgrm_version => '0',
