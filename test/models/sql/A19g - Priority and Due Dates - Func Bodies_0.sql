...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[  <bpmn:process id="Process_A19g" name="A19g - Priority and Due Dates - Func Bodies" isExecutable="true" apex:manualInput="false">]'
      ,q'[    <bpmn:extensionElements>]'
      ,q'[      <apex:priority>]'
      ,q'[        <apex:expressionType>plsqlRawFunctionBody</apex:expressionType>]'
      ,q'[        <apex:expression>return 5;</apex:expression>]'
      ,q'[      </apex:priority>]'
      ,q'[      <apex:dueOn>]'
      ,q'[        <apex:expressionType>plsqlRawFunctionBody</apex:expressionType>]'
      ,q'[        <apex:expression>declare ]'
      ,q'[    l_start timestamp with time zone;]'
      ,q'[    l_due   timestamp with time zone;]'
      ,q'[begin]'
      ,q'[    l_start := to_timestamp_tz('2023-06-21 23:59:59 AMERICA/LOS_ANGELES','YYYY-MM-DD HH24:MI:SS TZR');]'
      ,q'[    l_due := l_start + to_dsinterval('010 06:00:00');]'
      ,q'[    return l_due;]'
      ...
      ,q'[    <bpmndi:BPMNPlane id="BPMNPlane_1" bpmnElement="Process_A19g">]'
