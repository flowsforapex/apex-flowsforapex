...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[  <bpmn:process id="Process_A20a" name="A20a - Startability - Static" isExecutable="true" apex:isStartable="true" apex:manualInput="false">]'
      ...
      ,q'[    <bpmndi:BPMNPlane id="BPMNPlane_1" bpmnElement="Process_A20a">]'
  ...
  flow_diagram.upload_and_parse(
    pi_dgrm_name => 'A20a - Diagram Startability - Static',
    pi_dgrm_version => '0',
