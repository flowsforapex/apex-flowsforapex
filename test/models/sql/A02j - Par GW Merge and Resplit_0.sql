...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[  <bpmn:process id="Process_12j" name="Test Model 12j - Merge Split Par Gateways" isExecutable="false" apex:isCallable="false" apex:manualInput="false">]'
      ...
      ,q'[    <bpmn:parallelGateway id="Gateway_Split" name="Gateway Split">]'
      ...
      ,q'[    <bpmn:parallelGateway id="Gateway_MergeSplit" name="Gateway MergeSplit">]'
      ...
      ,q'[    <bpmndi:BPMNPlane id="BPMNPlane_1" bpmnElement="Process_12j">]'
      ...
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Gateway_0akdlv7_di" bpmnElement="Gateway_Split">]'
      ,q'[        <dc:Bounds x="395" y="455" width="50" height="50" />]'
      ,q'[        <bpmndi:BPMNLabel>]'
      ,q'[          <dc:Bounds x="337" y="433" width="66" height="14" />]'
      ,q'[        </bpmndi:BPMNLabel>]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Gateway_1vpydbe_di" bpmnElement="Gateway_MergeSplit">]'
  ...
  flow_diagram.upload_and_parse(
    pi_dgrm_name => 'A02j - Par GW Merge and Resplit',
    pi_dgrm_version => '0',
