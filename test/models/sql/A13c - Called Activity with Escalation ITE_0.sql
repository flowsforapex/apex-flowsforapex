...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[  <bpmn:process id="Process_EscalationITE" name="Escalation ITE" isExecutable="false" apex:isCallable="true" apex:manualInput="false">]'
      ,q'[    <bpmn:documentation>This Process just implements an Escalation Throw via an ICE with an Escalation then returns.</bpmn:documentation>]'
      ...
      ,q'[      <bpmn:escalationEventDefinition id="EscalationEventDefinition_16g9ht2" />]'
      ,q'[    </bpmn:intermediateThrowEvent>]'
      ,q'[  </bpmn:process>]'
      ,q'[  <bpmndi:BPMNDiagram id="BPMNDiagram_1">]'
      ,q'[    <bpmndi:BPMNPlane id="BPMNPlane_1" bpmnElement="Process_EscalationITE">]'
      ...
      ,q'[        </bpmndi:BPMNLabel>]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Event_1gin12f_di" bpmnElement="Event_End_Called">]'
      ,q'[        <dc:Bounds x="522" y="442" width="36" height="36" />]'
      ,q'[        <bpmndi:BPMNLabel>]'
      ,q'[          <dc:Bounds x="516" y="485" width="52" height="14" />]'
      ,q'[        </bpmndi:BPMNLabel>]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Event_0j107fa_di" bpmnElement="Event_ITE">]'
  ...
  flow_diagram.upload_and_parse(
    pi_dgrm_name => 'A13c - Called Activity with Escalation ITE',
    pi_dgrm_version => '0',
