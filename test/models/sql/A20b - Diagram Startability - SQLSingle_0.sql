...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[  <bpmn:process id="Process_A20b" name="A20b - Startability - SQLSingle" isExecutable="true" apex:isStartable="true" apex:manualInput="false">]'
      ...
      ,q'[from emp ]'
      ,q'[where job = 'PRESIDENT'</apex:expression>]'
      ,q'[      </apex:potentialStartingUsers>]'
      ,q'[      <apex:potentialStartingGroups>]'
      ,q'[        <apex:expressionType>sqlQuerySingle</apex:expressionType>]'
      ,q'[        <apex:expression>select 'SALES' from dual</apex:expression>]'
      ,q'[      </apex:potentialStartingGroups>]'
      ,q'[      <apex:excludedStartingUsers>]'
      ,q'[        <apex:expressionType>sqlQuerySingle</apex:expressionType>]'
      ,q'[        <apex:expression>select 'BADBOSS' from dual</apex:expression>]'
      ,q'[      </apex:excludedStartingUsers>]'
      ,q'[    </bpmn:extensionElements>]'
      ...
      ,q'[    <bpmndi:BPMNPlane id="BPMNPlane_1" bpmnElement="Process_A20b">]'
  ...
  flow_diagram.upload_and_parse(
    pi_dgrm_name => 'A20b - Diagram Startability - SQLSingle',
    pi_dgrm_version => '0',
