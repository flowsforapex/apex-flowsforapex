...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[  <bpmn:process id="Process_EscalationEnd" name="Escalation End" isExecutable="false" apex:isCallable="true" apex:manualInput="false">]'
      ,q'[    <bpmn:documentation>This Process just implements an Error Throw from a Error End Event.  It also sets a proc Var which can be returned on a normal ending</bpmn:documentation>]'
      ...
      ,q'[      <bpmn:errorEventDefinition id="ErrorEventDefinition_0sa3yb9" />]'
      ,q'[    </bpmn:endEvent>]'
      ,q'[  </bpmn:process>]'
      ,q'[  <bpmndi:BPMNDiagram id="BPMNDiagram_1">]'
      ,q'[    <bpmndi:BPMNPlane id="BPMNPlane_1" bpmnElement="Process_EscalationEnd">]'
      ...
      ,q'[        </bpmndi:BPMNLabel>]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Event_08felq6_di" bpmnElement="Event_End_Called">]'
  ...
  flow_diagram.upload_and_parse(
    pi_dgrm_name => 'A14b - Called Activity with Error End',
    pi_dgrm_version => '0',
