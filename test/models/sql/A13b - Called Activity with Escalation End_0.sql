...
begin
  l_dgrm_content := apex_string.join_clob(
    apex_t_varchar2(
      ...
      ,q'[      <bpmn:escalationEventDefinition id="EscalationEventDefinition_0kx9osl" />]'
      ,q'[    </bpmn:endEvent>]'
      ,q'[  </bpmn:process>]'
      ...
      ,q'[        </bpmndi:BPMNLabel>]'
      ,q'[      </bpmndi:BPMNShape>]'
      ,q'[      <bpmndi:BPMNShape id="Event_0a97eji_di" bpmnElement="Event_End_Called">]'
  ...
  flow_diagram.upload_and_parse(
    pi_dgrm_name => 'A13b - Called Activity with Escalation End',
    pi_dgrm_version => '0',
