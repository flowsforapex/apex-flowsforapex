create view flow_p0010_4_vw.sql
as
select sbfl_id
    , sbfl_parent_subflow
    ...
    , case 
        ...
        when flows_api_pkg.next_multistep_exists(p_process_id => :P10_ID, p_subflow_id =>sbfl_id) = 'n' 
            then 'next-subflow-step-link fa fa-sign-out'
        when flows_api_pkg.next_multistep_exists(p_process_id => :P10_ID, p_subflow_id =>sbfl_id) = 'y' 
