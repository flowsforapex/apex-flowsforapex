...
/
prompt --application/shared_components/plugins/process_type/com_flows4apex_set_prcs_var_process
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(14619294648961651)
,p_plugin_type=>'PROCESS TYPE'
,p_name=>'COM.FLOWS4APEX.SET_PRCS_VAR.PROCESS'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(14619461588961651)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(14619815199961653)
,p_plugin_attribute_id=>wwv_flow_api.id(14619461588961651)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(14620389487961653)
,p_plugin_attribute_id=>wwv_flow_api.id(14619461588961651)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(14620867207961653)
,p_plugin_id=>wwv_flow_api.id(14619294648961651)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(14624206912971182)
,p_plugin_attribute_id=>wwv_flow_api.id(14623950584969039)
,p_display_sequence=>10
,p_display_value=>'APEX item(s)'
,p_return_value=>'item'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(14624661020971815)
,p_plugin_attribute_id=>wwv_flow_api.id(14623950584969039)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(14625052656973850)
,p_plugin_attribute_id=>wwv_flow_api.id(14623950584969039)
,p_display_sequence=>30
...
,p_supported_ui_types=>'DESKTOP'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(14623950584969039)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'item'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
