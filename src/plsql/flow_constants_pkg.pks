...
as
  ...
  gc_apex_usertask_apex_simple_form   constant flow_types_pkg.t_bpmn_id := 'apexSimpleForm';
  gc_apex_usertask_apex_auto_form     constant flow_types_pkg.t_bpmn_id := 'apexAutoForm';
