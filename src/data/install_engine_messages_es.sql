...
begin
  ...
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'msgflow-lock-timeout-msub', c_load_lang, q'[Suscripción de mensaje bloqueada por otro usuario.  Inténtelo de nuevo.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
  ...
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'archive-destination-null', c_load_lang, q'[No se ha configurado ningún destino de archivado o registro. Consulte Configuraciones &gt; Registro o archivado.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'var_exp_plsql_other', c_load_lang, q'[Error al establecer la variable de proceso %1 en el ID de proceso %0 (definición %2). Error PL/SQL mostrado en el log de eventos.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-parent-not-call-act', c_load_lang, q'[Rebobinar: el subflujo principal no es una actividad de llamada a la que rebobinar.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'gateway-no-previous-gw', c_load_lang, q'[No se ha encontrado ningún gateway inclusivo o paralelo de apertura anterior para el subflujo %0.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'resume-invalid-status', c_load_lang, q'[Solo se pueden reanudar las instancias de proceso actualmente en estado suspendido.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-no-matched-object', c_load_lang, q'[Rebobinar: no se ha encontrado ningún objeto de apertura coincidente al que rebobinar.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-unknown-gw-status', c_load_lang, q'[Rebobinar: estado desconocido del gateway al rebobinar al gateway anterior.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-no-previous-gateway', c_load_lang, q'[Rebobinar: no se ha encontrado ninguna puerta de enlace anterior a la que rebobinar.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-no-parent-call-act', c_load_lang, q'[Rebobinar: no se ha encontrado ningún subflujo de actividad de llamada principal al que rebobinar.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-split-event-based-gw', c_load_lang, q'[Rebobinar: no se puede rebobinar desde un gateway basado en eventos que aún se está ejecutando. Rebobine primero uno de los subflujos de reenvío al gateway basado en eventos.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'exec_plsql_other', c_load_lang, q'[Error al ejecutar PL/SQL. Error PL/SQL mostrado en el log de eventos.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'gateway-matching-object-error', c_load_lang, q'[Error al recuperar el objeto de gateway coincidente para el subflujo %0, paso actual %1.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'exec_sql_too_many_cols', c_load_lang, q'[Error al ejecutar la consulta SQl: la consulta devuelve más de una columna.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-no-parent-subflow', c_load_lang, q'[Rebobinar: no se ha encontrado ningún subflujo principal.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'exec_sql_too_many_rows', c_load_lang, q'[Error al establecer la variable de proceso %1 en el ID de proceso %0 (definición %2). La consulta devuelve varias filas.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-cant-gway-from-event', c_load_lang, q'[Rebobinar: no se puede rebobinar a la puerta de enlace anterior del evento.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'logging-event-level', c_load_lang, q'[Flujos: error interno al obtener el nivel de registro]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-not-wait-at-gateway', c_load_lang, q'[Rebobinar: el subflujo no está esperando en una puerta de enlace para rebobinar hasta el último paso.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'exec_sql_too_many_values', c_load_lang, q'[Error al ejecutar la consulta SQL: la consulta devuelve más de un valor.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'timer-internal-error', c_load_lang, q'[Error interno del temporizador para el objeto %0. Tipo: %1; Valor: %2]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'suspend-invalid-status', c_load_lang, q'[Solo se pueden suspender las instancias de proceso actualmente en ejecución o con estado de error.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-force-step-not-error', c_load_lang, q'[No se puede forzar el siguiente paso en el subflujo que no tiene el estado de error.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'gateway-multiple-previous-gws', c_load_lang, q'[Se han encontrado varias puertas de enlace paralelas o inclusivas de apertura anteriores para el subflujo %0.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'suspended-cannot-complete-step', c_load_lang, q'[Esta instancia de proceso está suspendida actualmente. Por favor, vuelve a intentarlo más tarde.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-no-last-step', c_load_lang, q'[Rebobinado: no se encontró el último paso completado inmediatamente antes de la puerta de enlace a la que rebobinar. ]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-step-reposition-error', c_load_lang, q'[Rebobinar: error al cambiar la posición del paso.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-no-current-step', c_load_lang, q'[Rebobinar: el paso de destino solicitado para rebobinar no es una transición válida desde el paso actual.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-matching-object-error', c_load_lang, q'[Rebobinar: error al obtener el objeto coincidente para rebobinar del log de subflujo.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'exec_sql_other', c_load_lang, q'[Error al ejecutar la consulta SQL. Error SQL mostrado en el log de eventos.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-parent-not-subproc', c_load_lang, q'[Rebobinar: el subflujo principal no es un subproceso al que rebobinar.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-completion-invalid-json', c_load_lang, q'[La condición de finalización de subproceso ad hoc para el objeto %0 no es un JSON válido.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-reco-not-found', c_load_lang, q'[No se ha encontrado ningún subproceso ad hoc activo para la aprobación de recomendaciones.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-not-startable-objt', c_load_lang, q'[La actividad %0 no puede iniciarse desde un subproceso ad hoc.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-subprocess-not-found', c_load_lang, q'[No se ha encontrado el subproceso ad hoc o ya ha finalizado para el proceso %0, subflujo %1, paso %2.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-already-started', c_load_lang, q'[La actividad %0 ya se ha iniciado en este subproceso ad hoc.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-start-acts-bad-config', c_load_lang, q'[La definición de actividades de inicio de subproceso ad hoc para el objeto %0 no es válida.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-ai-bad-config', c_load_lang, q'[El subproceso ad hoc %0 tiene una configuración de AI no válida para la interfaz %1. Falta la configuración o no es válida: %2]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-start-acts-error', c_load_lang, q'[Error al iniciar las actividades ad hoc predeterminadas para el subproceso ad hoc %0. %1]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-reco-already-disp', c_load_lang, q'[La recomendación ya se ha despachado o descartado.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'var_exp_jsonpath_error', c_load_lang, q'[Error al establecer la variable de proceso %1 en el ID de proceso %1. Expresión JSONPath "%2" (Subflujo: %0, Conjunto: %3).]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-not-recommendation-mode', c_load_lang, q'[El subproceso no está en modo de control de recomendación.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'input_parameter-invalid-json', c_load_lang, q'[El parámetro de entrada para la actividad %0 contiene un JSON %1 no válido.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-startable-acts-error', c_load_lang, q'[Error al evaluar las actividades iniciables para el subproceso ad hoc %0. %1]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-ai-call-failed', c_load_lang, q'[Fallo de llamada de IA para el subproceso ad hoc %0 mediante la interfaz %1. %2]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-recommendation-stale', c_load_lang, q'[No se ha encontrado la recomendación o pertenece a un subproceso diferente.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-reco-activity-not-set', c_load_lang, q'[La actividad no está en el juego de acciones de recomendación pendiente.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-ai-bad-iface', c_load_lang, q'[El subproceso ad hoc %0 utiliza la interfaz AI %1 no admitida.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-completion-cond-error', c_load_lang, q'[Error al evaluar la condición de finalización de subproceso ad hoc para el objeto %0. %1]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-ai-invalid-response', c_load_lang, q'[AI devolvió una respuesta de control no válida para el subproceso ad hoc %0. %1]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-ai-invoke-error', c_load_lang, q'[Error al invocar el control AI ad hoc para el objeto %0. %1]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
  ...
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'apex-task-cancelation-error', c_load_lang, q'[Error al intentar cancelar la tarea humana de APEX (task_id: %1 ) para el paso de proceso: %0.)]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'apex-task-not-found', c_load_lang, q'[No se ha encontrado la tarea humana de APEX %0 en el proceso Flows for APEX]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'apex-task-on-multiple-steps', c_load_lang, q'[Se ha encontrado APEX Human Task %0 asociado a más de un paso de proceso Flows for APEX.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'apex-task-not-current-step', c_load_lang, q'[APEX Human Task %0 no es el paso actual del proceso. Es posible que el paso haya completado todo listo.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'apex-task-invalid-result-var', c_load_lang, q'[La variable de proceso de resultado de Human Task de APEX no está definida o no es válida.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'apex-task-creation-error', c_load_lang, q'[Error al crear la tarea humana de APEX %0 en la aplicación %1. Consulte la depuración para obtener más información.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
