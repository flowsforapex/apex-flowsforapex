...
begin
  ...
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'var-get-error', c_load_lang, q'[No se puede obtener el valor de la variable de proceso %0. Consulte los logs de instancia para obtener más información.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
  ...
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'due-on-error', c_load_lang, q'[Error al evaluar el vencimiento. La expresión Vencimiento no es válida. Expresión de intervalo: %0. Se ha utilizado en su lugar el registro de hora de sistema.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
