...
begin
  ...
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'apex-task-not-found', c_load_lang, q'[Task umano APEX %0 non trovato nel processo Flows for APEX]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'apex-task-on-multiple-steps', c_load_lang, q'[Trovato task umano APEX %0 associato a più passi del processo Flows for APEX.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'apex-task-not-current-step', c_load_lang, q'[Il task umano APEX %0 non è il passo corrente del processo. Il passo potrebbe aver completato tutto pronto.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'apex-task-invalid-result-var', c_load_lang, q'[Variabile di processo dei risultati del task umano APEX non definita o non valida.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'apex-task-creation-error', c_load_lang, q'[Errore durante la creazione del task APEX Human %0 nell'applicazione %1. Per i dettagli, vedere il debug.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'apex-task-priority-error', c_load_lang, q'[Errore durante la valutazione della priorità. La priorità deve essere compresa tra 1 e 5. Priorità: %0.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
  ...
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'msgflow-no-longer-current-step', c_load_lang, q'[Messaggio correlato, ma l'oggetto ricevente non è più l'oggetto corrente nel relativo flusso secondario.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
  ...
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-parent-not-call-act', c_load_lang, q'[Rewind: il flusso secondario padre non è un'attività di chiamata a cui riavvolgere.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'gateway-no-previous-gw', c_load_lang, q'[Nessun gateway parallelo o inclusivo di apertura precedente trovato per il flusso secondario %0.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'resume-invalid-status', c_load_lang, q'[È possibile riprendere solo le istanze di processo attualmente in stato sospeso.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-no-matched-object', c_load_lang, q'[Rewind - nessun oggetto di apertura corrispondente trovato per il riavvolgimento.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-unknown-gw-status', c_load_lang, q'[Rewind: stato del gateway sconosciuto durante il rewind al gateway precedente.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-no-previous-gateway', c_load_lang, q'[Rewind: nessun gateway precedente in cui riavvolgersi.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-no-parent-call-act', c_load_lang, q'[Rewind: nessun flusso secondario attività chiamata padre trovato per il riavvolgimento.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-split-event-based-gw', c_load_lang, q'[ Rewind: impossibile eseguire di nuovo il riavvolgimento da un gateway basato su eventi ancora in esecuzione. Riavviare prima uno dei flussi secondari di inoltro al gateway basato su eventi.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'exec_plsql_other', c_load_lang, q'[Errore durante l'esecuzione di PL/SQL. Errore PL/SQL visualizzato nel log eventi.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'gateway-matching-object-error', c_load_lang, q'[Errore durante il recupero dell'oggetto gateway corrispondente per il flusso secondario %0, passo corrente %1.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'exec_sql_too_many_cols', c_load_lang, q'[Errore durante l'esecuzione della query SQl. La query restituisce più di una colonna.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-no-parent-subflow', c_load_lang, q'[Rewind - nessun flusso secondario padre trovato.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'exec_sql_too_many_rows', c_load_lang, q'[Errore durante l'impostazione della variabile di processo %1 nell'ID processo %0 (set %2). La query restituisce più righe.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-cant-gway-from-event', c_load_lang, q'[Rewind: impossibile riavvolgere dall'evento il gateway precedente.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'logging-event-level', c_load_lang, q'[Flussi - Errore interno durante il recupero del livello di log]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-not-wait-at-gateway', c_load_lang, q'[Rewind: il flusso secondario non è in attesa di un gateway per riavvolgere l'ultimo passo.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'exec_sql_too_many_values', c_load_lang, q'[Errore durante l'esecuzione della query SQL: la query restituisce più di un valore.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'timer-internal-error', c_load_lang, q'[Errore interno del timer per l'oggetto %0. Tipo: %1; Valore: %2]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'suspend-invalid-status', c_load_lang, q'[È possibile sospendere solo le istanze di processo attualmente in esecuzione o in stato di errore.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-force-step-not-error', c_load_lang, q'[Impossibile forzare il passo successivo sul flusso secondario non in stato di errore.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'gateway-multiple-previous-gws', c_load_lang, q'[Trovati più gateway paralleli o inclusivi di apertura precedenti per il flusso secondario %0.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'suspended-cannot-complete-step', c_load_lang, q'[Questa istanza del processo è attualmente sospesa. Riprovare più tardi.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-no-last-step', c_load_lang, q'[Rewind: nessun ultimo passo completato trovato immediatamente prima del gateway a cui riavvolgersi. ]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-step-reposition-error', c_load_lang, q'[Rewind - errore durante il riposizionamento del passo.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-no-current-step', c_load_lang, q'[Rewind: il passo di destinazione richiesto per il riavvolgimento non è una transizione valida dal passo corrente.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-matching-object-error', c_load_lang, q'[Rewind - errore durante il recupero dell'oggetto corrispondente per il rewind dal log del flusso secondario. ]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'exec_sql_other', c_load_lang, q'[Errore durante l'esecuzione della query SQL. Errore SQL visualizzato nel log eventi.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'rewind-parent-not-subproc', c_load_lang, q'[Rewind: il flusso secondario padre non è un processo secondario a cui riavvolgere.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-completion-invalid-json', c_load_lang, q'[La condizione di completamento del sottoprocesso ad hoc per l'oggetto %0 non è JSON valido.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-reco-not-found', c_load_lang, q'[Nessun processo secondario ad hoc attivo trovato per l'approvazione del suggerimento.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-not-startable-objt', c_load_lang, q'[Attività %0 non avviabile da un sottoprocesso ad hoc.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-subprocess-not-found', c_load_lang, q'[Sottoprocesso ad hoc non trovato o già completato per il processo %0, flusso secondario %1, passo %2.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-already-started', c_load_lang, q'[L'attività %0 è già stata avviata in questo processo secondario ad hoc.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-start-acts-bad-config', c_load_lang, q'[La definizione delle attività di avvio del sottoprocesso ad hoc per l'oggetto %0 non è valida.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-ai-bad-config', c_load_lang, q'[Il sottoprocesso ad hoc %0 ha una configurazione AI non valida per l'interfaccia %1. Impostazione mancante o non valida: %2]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-start-acts-error', c_load_lang, q'[Errore durante l'avvio delle attività ad hoc predefinite per il sottoprocesso ad hoc %0. %1]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-reco-already-disp', c_load_lang, q'[La raccomandazione è già stata inviata o eliminata.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'var_exp_jsonpath_error', c_load_lang, q'[Errore durante l'impostazione della variabile processo %1 nell'ID processo %1. Espressione  JSONPath "%2" (flusso secondario: %0, set: %3).]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-not-recommendation-mode', c_load_lang, q'[Il sottoprocesso non è in modalità di controllo raccomandazione.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'input_parameter-invalid-json', c_load_lang, q'[Il parametro di input per l'attività %0 contiene JSON %1 non valido.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-startable-acts-error', c_load_lang, q'[Errore durante la valutazione delle attività con stella per il sottoprocesso ad hoc %0. %1]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-ai-call-failed', c_load_lang, q'[Chiamata AI non riuscita per il sottoprocesso ad hoc %0 che utilizza l'interfaccia %1. %2]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-recommendation-stale', c_load_lang, q'[Suggerimento non trovato o appartenente a un processo secondario diverso.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-reco-activity-not-set', c_load_lang, q'[L'attività non è inclusa nel set di azioni consiglio in sospeso.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-ai-bad-iface', c_load_lang, q'[Il sottoprocesso ad hoc %0 utilizza un'interfaccia AI %1 non supportata.]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-completion-cond-error', c_load_lang, q'[Errore durante la valutazione della condizione di completamento del sottoprocesso ad hoc per l'oggetto %0. %1]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-ai-invalid-response', c_load_lang, q'[AI ha restituito una risposta di controllo non valida per il sottoprocesso ad hoc %0. %1]' );
  insert into flow_messages( fmsg_message_key, fmsg_lang, fmsg_message_content )
    values ( 'adhoc-ai-invoke-error', c_load_lang, q'[Errore durante il richiamo del controllo AI ad hoc per l'oggetto %0. %1]' );
