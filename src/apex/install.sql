...
@@application/shared_components/security/authorizations/enterprise_edition.sql
...
@@application/shared_components/plugins/region_type/json_region_uwesimon_selfhost_e.sql
