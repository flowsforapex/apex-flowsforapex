...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(11214749648054909)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(24202222744578370)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3192334722229270)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3310158364323358)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(24202222744578370)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#:t-Button--iconLeft'
,p_button_template_id=>wwv_flow_imp.id(12495521691135880126)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3191696373229270)
...
,p_process_when_button_id=>wwv_flow_imp.id(3192334722229270)
,p_process_success_message=>'Changes saved.'
,p_internal_uid=>3204611384229276
);
