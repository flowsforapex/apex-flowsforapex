...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7938399981499706)
...
,p_list_id=>wwv_flow_imp.id(7959288629726086)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(12495525309455880143)
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(22800510543488044)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(24418438259878743)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(34403031827171416)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(15683484308738625)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(34403031827171416)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(7938283749499705)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15681777930738608)
,p_name=>'P4_DGRM_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(22800510543488044)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22800638443488045)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(24418616934878745)
,p_name=>'P4_DIAGRAM_XML'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(24418438259878743)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(22800733881488046)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(15683695432738627)
,p_name=>'Apply Changes Clicked'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(15683484308738625)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(22801024059488049)
,p_event_id=>wwv_flow_imp.id(15683695432738627)
,p_event_result=>'TRUE'
