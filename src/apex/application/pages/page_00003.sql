...
,p_last_upd_yyyymmddhh24miss=>'20200702140322'
);
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(12494269218790128230)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(12494270788368128245)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(12493544203822486105)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12493548529122486148)
...
,p_process_when_button_id=>wwv_flow_api.id(12494269218790128230)
,p_process_success_message=>'Diagram deleted.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(165495774331747087)
