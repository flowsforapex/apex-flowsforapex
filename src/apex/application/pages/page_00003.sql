...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(13534267345081021727)
,p_plug_name=>'Form'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(13534268914659021742)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(13534267345081021727)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(13534267668149021730)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(13534993929626663867)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13534267471884021728)
,p_name=>'P3_NAME'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(13534267345081021727)
,p_prompt=>'Name'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(13534990291941663831)
,p_name=>'Reload List'
,p_event_sequence=>20
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(13534990376999663832)
,p_event_id=>wwv_flow_api.id(13534990291941663831)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(13534989604326663824)
