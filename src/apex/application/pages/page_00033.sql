...
,p_last_upd_yyyymmddhh24miss=>'20230515132638'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(11186537419048718)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(3746146895530325)
,p_name=>'JSON Configuration'
,p_parent_plug_id=>wwv_flow_api.id(11186537419048718)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(3746305351530327)
,p_query_column_id=>1
,p_column_alias=>'D'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(24201499202577457)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3512936201851742)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(3746146895530325)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3164119045223081)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3309455839322446)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(24201499202577457)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#:t-Button--iconLeft'
,p_button_template_id=>wwv_flow_api.id(12495521691135880126)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3161511927223080)
,p_name=>'P33_LOGGING_ARCHIVE_ENABLED'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(11186537419048718)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3161978411223080)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(3170508084223084)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3746400769530328)
,p_name=>'On dialog close'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(3512936201851742)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3746576221530329)
,p_event_id=>wwv_flow_api.id(3746400769530328)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(3746146895530325)
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3747022152530334)
,p_name=>'On Refresh JSON'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(3746146895530325)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterrefresh'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3747195167530335)
,p_event_id=>wwv_flow_api.id(3747022152530334)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3176434129223085)
...
,p_process_when_button_id=>wwv_flow_api.id(3164119045223081)
