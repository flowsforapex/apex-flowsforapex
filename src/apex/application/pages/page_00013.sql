...
,p_last_upd_yyyymmddhh24miss=>'20210825084054'
);
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'LGVR_PRCS_ID:LGVR_OBJT_ID:LGVR_VAR_NAME:LGVR_EXPR_SET:LGVR_TIMESTAMP:LGVR_VAR_TYPE:LGVR_VALUE'
);
wwv_flow_api.create_page_plug(
