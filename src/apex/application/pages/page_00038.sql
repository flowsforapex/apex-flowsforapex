...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3512217433851735)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3747249703530336)
,p_plug_name=>'Choose the active destination'
,p_parent_plug_id=>wwv_flow_imp.id(3512217433851735)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3747347338530337)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3745995977530323)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3745589259530319)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3745995977530323)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3745670019530320)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3512603514851739)
,p_name=>'P38_CFIG_KEY'
,p_source_data_type=>'VARCHAR2'
,p_is_primary_key=>true
,p_is_query_only=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3512217433851735)
,p_item_source_plug_id=>wwv_flow_imp.id(3512217433851735)
,p_source=>'CFIG_KEY'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3512743931851740)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3513035181851743)
,p_name=>'P38_DESTINATION_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3747249703530336)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3513116353851744)
,p_name=>'P38_TABLE_NAME'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(3747347338530337)
,p_prompt=>'Table Name'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3513290888851745)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3513352883851746)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3513454878851747)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3743758890530301)
,p_name=>'P38_BASE_URL'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(3747347338530337)
,p_prompt=>'Base URL'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3743862263530302)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3743975741530303)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3744055656530304)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3744138186530305)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3747558988530339)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3747603686530340)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(3746058063530324)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3744327033530307)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3744474525530308)
,p_event_id=>wwv_flow_imp.id(3744327033530307)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3744597361530309)
,p_event_id=>wwv_flow_imp.id(3744327033530307)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3744633233530310)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3744771169530311)
,p_event_id=>wwv_flow_imp.id(3744633233530310)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3747744242530341)
,p_event_id=>wwv_flow_imp.id(3744633233530310)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3744919862530313)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3745034758530314)
,p_event_id=>wwv_flow_imp.id(3744919862530313)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3747827765530342)
,p_event_id=>wwv_flow_imp.id(3744919862530313)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3745700945530321)
,p_name=>'Click on Cancel'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3745670019530320)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3745870785530322)
,p_event_id=>wwv_flow_imp.id(3745700945530321)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3512846601851741)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(3512217433851735)
...
,p_internal_uid=>3512846601851741
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3746695353530330)
...
,p_attribute_02=>'N'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>3746695353530330
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3512551612851738)
,p_process_sequence=>10
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>3512551612851738
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3744274227530306)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>3744274227530306
);
