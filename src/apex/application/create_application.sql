...
,p_authentication_id=>wwv_flow_imp.id(12495636783173880401)
,p_application_tab_set=>1
,p_logo_type=>'IT'
,p_logo=>'#APP_IMAGES#app-100-logo.png'
,p_logo_text=>'Flows for APEX'
,p_app_builder_icon_name=>'flows-apex.svg'
...
,p_last_upd_yyyymmddhh24miss=>'20240926144146'
,p_file_prefix => nvl(wwv_flow_application_install.get_static_app_file_prefix,'')
,p_files_version=>1118
,p_ui_type_name => null
