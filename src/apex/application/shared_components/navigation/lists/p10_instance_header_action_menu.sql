...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(2431522092873048)
,p_name=>'P10_INSTANCE_HEADER_ACTION_MENU'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(2432103661873123)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(2432511726873124)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(2432979512873125)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(2433306262873126)
