...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(23036038156990674871)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24620486326888938649)
,p_plugin_id=>wwv_flow_api.id(23036038156990674871)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24628652549734203524)
,p_plugin_id=>wwv_flow_api.id(23036038156990674871)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24628848729920205154)
,p_plugin_id=>wwv_flow_api.id(23036038156990674871)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24628854956916206552)
,p_plugin_id=>wwv_flow_api.id(23036038156990674871)
,p_attribute_scope=>'COMPONENT'
