...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(11258952541008552)
,p_lov_name=>'P5_DOWNLOAD_AS'
,p_lov_query=>'.'||wwv_flow_imp.id(11258952541008552)||'.'
,p_location=>'STATIC'
,p_version_scn=>1760504929
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(11259254401008560)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'BPMN File'
,p_lov_return_value=>'BPMN'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(11259507519008561)
