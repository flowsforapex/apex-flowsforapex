...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(12495622898900880302)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9945091204536046)
,p_page_template_id=>wwv_flow_imp.id(12495622898900880302)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9945598838536046)
,p_page_template_id=>wwv_flow_imp.id(12495622898900880302)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9946042499536046)
,p_page_template_id=>wwv_flow_imp.id(12495622898900880302)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9946517272536046)
,p_page_template_id=>wwv_flow_imp.id(12495622898900880302)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9947009570536046)
,p_page_template_id=>wwv_flow_imp.id(12495622898900880302)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9947529163536046)
,p_page_template_id=>wwv_flow_imp.id(12495622898900880302)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9948098726536046)
,p_page_template_id=>wwv_flow_imp.id(12495622898900880302)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9948501231536046)
,p_page_template_id=>wwv_flow_imp.id(12495622898900880302)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9949006081536047)
,p_page_template_id=>wwv_flow_imp.id(12495622898900880302)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9949521176536047)
,p_page_template_id=>wwv_flow_imp.id(12495622898900880302)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9950079112536047)
,p_page_template_id=>wwv_flow_imp.id(12495622898900880302)
