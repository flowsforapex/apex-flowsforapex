...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2057848428679980)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2058305303679980)
,p_page_template_id=>wwv_flow_imp.id(12495632827206880321)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2058847287679980)
,p_page_template_id=>wwv_flow_imp.id(12495632827206880321)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2059333293679980)
,p_page_template_id=>wwv_flow_imp.id(12495632827206880321)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2059858451679980)
,p_page_template_id=>wwv_flow_imp.id(12495632827206880321)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2060350016679980)
,p_page_template_id=>wwv_flow_imp.id(12495632827206880321)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2060860610679980)
,p_page_template_id=>wwv_flow_imp.id(12495632827206880321)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2061393671679980)
,p_page_template_id=>wwv_flow_imp.id(12495632827206880321)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2061864282679980)
,p_page_template_id=>wwv_flow_imp.id(12495632827206880321)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2062325704679980)
,p_page_template_id=>wwv_flow_imp.id(12495632827206880321)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2062895658679979)
,p_page_template_id=>wwv_flow_imp.id(12495632827206880321)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2063302306679979)
,p_page_template_id=>wwv_flow_imp.id(12495632827206880321)
