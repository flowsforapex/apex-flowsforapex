...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(12495618547053880299)
,p_theme_id=>42
,p_name=>'Standard'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2078035504679976)
,p_page_template_id=>wwv_flow_imp.id(12495618547053880299)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2078557990679976)
,p_page_template_id=>wwv_flow_imp.id(12495618547053880299)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2079091787679976)
,p_page_template_id=>wwv_flow_imp.id(12495618547053880299)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2079544815679976)
,p_page_template_id=>wwv_flow_imp.id(12495618547053880299)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2080015108679976)
,p_page_template_id=>wwv_flow_imp.id(12495618547053880299)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2080542601679976)
,p_page_template_id=>wwv_flow_imp.id(12495618547053880299)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2081034099679975)
,p_page_template_id=>wwv_flow_imp.id(12495618547053880299)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2081519669679975)
,p_page_template_id=>wwv_flow_imp.id(12495618547053880299)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2082039899679975)
,p_page_template_id=>wwv_flow_imp.id(12495618547053880299)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2082563566679975)
,p_page_template_id=>wwv_flow_imp.id(12495618547053880299)
