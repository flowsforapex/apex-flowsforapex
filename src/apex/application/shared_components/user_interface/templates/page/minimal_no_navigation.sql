...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(12495616037696880296)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2068489538679978)
,p_page_template_id=>wwv_flow_imp.id(12495616037696880296)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2068990101679978)
,p_page_template_id=>wwv_flow_imp.id(12495616037696880296)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2069427683679978)
,p_page_template_id=>wwv_flow_imp.id(12495616037696880296)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2069986779679978)
,p_page_template_id=>wwv_flow_imp.id(12495616037696880296)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2070456243679978)
,p_page_template_id=>wwv_flow_imp.id(12495616037696880296)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2070906782679978)
,p_page_template_id=>wwv_flow_imp.id(12495616037696880296)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2071424489679978)
,p_page_template_id=>wwv_flow_imp.id(12495616037696880296)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2071904465679977)
,p_page_template_id=>wwv_flow_imp.id(12495616037696880296)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2072453234679977)
,p_page_template_id=>wwv_flow_imp.id(12495616037696880296)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2072903989679977)
,p_page_template_id=>wwv_flow_imp.id(12495616037696880296)
