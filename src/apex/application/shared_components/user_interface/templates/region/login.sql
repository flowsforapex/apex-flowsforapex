...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2249986470679926)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2250413686679926)
,p_plug_template_id=>wwv_flow_imp.id(12495583796584880235)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2250953094679926)
,p_plug_template_id=>wwv_flow_imp.id(12495583796584880235)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2251451757679926)
,p_plug_template_id=>wwv_flow_imp.id(12495583796584880235)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2251925971679925)
,p_plug_template_id=>wwv_flow_imp.id(12495583796584880235)
,p_name=>'Sub Regions'
