...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12495583796584880235)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10119309347536092)
,p_plug_template_id=>wwv_flow_imp.id(12495583796584880235)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10119836515536093)
,p_plug_template_id=>wwv_flow_imp.id(12495583796584880235)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10120373985536093)
,p_plug_template_id=>wwv_flow_imp.id(12495583796584880235)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10120820303536093)
,p_plug_template_id=>wwv_flow_imp.id(12495583796584880235)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10121315016536093)
,p_plug_template_id=>wwv_flow_imp.id(12495583796584880235)
,p_name=>'Sub Regions'
