...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10110463709536090)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10110926152536090)
,p_plug_template_id=>wwv_flow_imp.id(12495589722092880240)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10111486841536090)
,p_plug_template_id=>wwv_flow_imp.id(12495589722092880240)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10111972774536090)
,p_plug_template_id=>wwv_flow_imp.id(12495589722092880240)
,p_name=>'Sub Regions'
