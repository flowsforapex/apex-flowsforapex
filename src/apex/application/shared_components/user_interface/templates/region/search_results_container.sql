...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2308078652679909)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2308570062679907)
,p_plug_template_id=>wwv_flow_imp.id(2308078652679909)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2309011757679907)
,p_plug_template_id=>wwv_flow_imp.id(2308078652679909)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2309540596679907)
,p_plug_template_id=>wwv_flow_imp.id(2308078652679909)
,p_name=>'Sub Regions'
