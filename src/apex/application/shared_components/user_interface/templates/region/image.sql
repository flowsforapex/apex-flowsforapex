...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10210934346536117)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10211434407536117)
,p_plug_template_id=>wwv_flow_imp.id(10210934346536117)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10211903228536117)
,p_plug_template_id=>wwv_flow_imp.id(10210934346536117)
,p_name=>'Sub Regions'
