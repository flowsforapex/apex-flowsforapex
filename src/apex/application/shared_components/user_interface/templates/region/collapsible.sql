...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12495604368136880259)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2148051604679952)
,p_plug_template_id=>wwv_flow_imp.id(12495604368136880259)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2148565086679952)
,p_plug_template_id=>wwv_flow_imp.id(12495604368136880259)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2149051879679952)
,p_plug_template_id=>wwv_flow_imp.id(12495604368136880259)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2149548673679952)
,p_plug_template_id=>wwv_flow_imp.id(12495604368136880259)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2150021348679952)
,p_plug_template_id=>wwv_flow_imp.id(12495604368136880259)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2150539015679952)
,p_plug_template_id=>wwv_flow_imp.id(12495604368136880259)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2151088930679952)
,p_plug_template_id=>wwv_flow_imp.id(12495604368136880259)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2151558607679952)
,p_plug_template_id=>wwv_flow_imp.id(12495604368136880259)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2152058811679952)
,p_plug_template_id=>wwv_flow_imp.id(12495604368136880259)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2152560183679952)
,p_plug_template_id=>wwv_flow_imp.id(12495604368136880259)
,p_name=>'Sub Regions'
