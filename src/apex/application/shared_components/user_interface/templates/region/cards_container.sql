...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1792064716043263)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2116264190679961)
,p_plug_template_id=>wwv_flow_imp.id(1792064716043263)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2116706183679961)
,p_plug_template_id=>wwv_flow_imp.id(1792064716043263)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2117220858679961)
,p_plug_template_id=>wwv_flow_imp.id(1792064716043263)
,p_name=>'Sub Regions'
