...
ALTER TABLE flow_object_attributes ADD CONSTRAINT obat_pk PRIMARY KEY ( obat_objt_id,
                                                                        obat_key );
...
CREATE TABLE flow_objects (
    ...
    objt_timer_date VARCHAR2(50 CHAR), 
	  ...
	  objt_timer_cycle VARCHAR2(50 CHAR)
);
...
CREATE TABLE flow_timers (
    ...
    timr_date_string      VARCHAR2(50 CHAR),
    timr_duration_string  VARCHAR2(50 CHAR),
    timr_cycle_string     VARCHAR2(50 CHAR),
...
COMMENT ON COLUMN flow_timers.timr_duration_string IS
    'Temporary column for testing. It will be removed when the new model from Moritz is available.';

COMMENT ON COLUMN flow_timers.timr_cycle_string IS
    'Temporary column for testing. It will be removed when the new model from Moritz is available.';
